import { Colors, EmbedBuilder, SlashCommandNumberOption, SlashCommandRoleOption } from "discord.js";
import { PrismaClient } from '@prisma/client';
import { getServerConfigs } from '../../../../utils/prismaUtils.js';
import { permissionsCheck } from '../../../../utils/roleFunctions.js';
const prisma = new PrismaClient();
export default class BindGroupSubcommand {
    name = "group";
    description = "Allows the binding of ROBLOX group data to a discord role.";
    guardsman;
    options = [
