import { Colors, EmbedBuilder, SlashCommandStringOption, ActionRowBuilder, ButtonBuilder, ButtonStyle, ComponentType } from "discord.js";
import { getServerConfigs } from '../../../../utils/prismaUtils.js';
import { permissionsCheck } from '../../../../utils/roleFunctions.js';
export default class brLogSubCommand {
    name = "log";
            ...
            if (interaction.customId === 'accept') {
                ...
                if (permission && interaction.message.interaction) {
                    ...
                    if (result) {
                        ...
                        this.guardsman.bot.emit("databaseError", interaction, result);
                    }
                }
            }
