import { Colors, EmbedBuilder, SlashCommandStringOption, ActionRowBuilder, ButtonBuilder, ButtonStyle, ComponentType, SlashCommandIntegerOption } from "discord.js";
import { getServerConfigs } from '../../../../utils/prismaUtils.js';
import { permissionsCheck } from '../../../../utils/roleFunctions.js';
export default class aptureRequestSubCommand {
    name = "request";
    description = "Operators can use this to request additions to the dad-joke counter.";
    guardsman;
    options = [
            ...
            if (interaction.customId === 'accept') {
                ...
                if (permission && interaction.message.interaction) {
                    ...
                    if (counter) {
                        ...
                        this.guardsman.bot.emit("databaseError", interaction, counter);
                    }
                }
            }
