...
export default class OperatorUpdateSubcommand {
    name = "update";
    description = "Allows users to update their Discord roles.";
    guardsman;
    options = [
                    ...
                    await interaction.editReply({
                        ...
                        embeds: [
                            new EmbedBuilder()
                                ...
                                .setDescription("Only TRU Leadership and above may update other users.")
