import { Client, Collection, IntentsBitField, REST, Routes, SlashCommandBuilder, SlashCommandSubcommandBuilder } from "discord.js";
...
export default class Bot extends Client {
    ...
    pendingVerificationInteractions = {};
    commands = {
        list: new Collection(),
        read: async () => {
            ...
            for (const categoryDir of categoryDirs) {
                ...
                for (const commandFile of commandFiles) {
                    ...
                    console.log(`./commands/${categoryDir}/${commandFile}${commandFileStat.isDirectory() && "/index.js" || ""}`);
                    const commandClass = (await import(`./commands/${categoryDir}/${commandFile}${commandFileStat.isDirectory() && "/index.js" || ""}`)).default;
                    const commandData = new commandClass(this.guardsman);
        ...
        push: async () => {
            ...
            await DiscordAPI.put(Routes.applicationCommands(this.guardsman.environment.DISCORD_BOT_CLIENT_ID), {
                body: parsedCommands
            });
        }
    };
