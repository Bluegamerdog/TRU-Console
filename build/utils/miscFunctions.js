export function changeNickname(newRankName, currentNick) {
...
export function chunkStringByNewline(str, maxLength) {
    const chunks = [];
...
export function getAbbreviation(RankName) {
    const rankAbbreviations = {
        "Entrant": "ENT",
        "Operator": "OPR",
        "Senior Operator": "SOPR",
...
export function getAbbreviation_2(RankName) {
    const rankAbbreviations = {
        "Entrant": "(**ENT**)",
        "Operator": "(**OPR**)",
        "Senior Operator": "(**SOPR**)",
...
export function getRank_fromID(rankIdentifier) {
    const rankInfo = {
        "1": "Entrant",
        "3": "Operator",
        "4": "Senior Operator",
...
export function get_promotion_message(rank_name) {
