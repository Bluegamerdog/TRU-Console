...
export default class OperatorRankSubcommand implements ICommand {
     name: Lowercase<string> = "rank";
     description: string = "Is used to promote or demote members.";
     guardsman: Guardsman;
     options: ApplicationCommandOptionBase[] = [
          ...
          new SlashCommandStringOption()
               ...
               .setRequired(true)
               .addChoices(
                    { name: 'Vanguard Officer', value: '20' },
                    { name: "Vanguard", value: "15" },
                    { name: "Elite Operator", value: "5" },
                    { name: "Senior Operator", value: "4" },
                    { name: "Operator", value: "3" },
                    { name: "Entrant", value: "1" }
               ),
          new SlashCommandStringOption()
     ...
     async execute(interaction: ChatInputCommandInteraction<"cached">): Promise<void> {
          ...
          const roleBindData: RoleData<any> = JSON.parse(getRobloxGroupID.role_data);
          ...
          if (currentRank < parseInt(rank)) { // Promotion
               ...
               try {
                    ...
                    const onDutyChannel = this.guardsman.bot.channels.cache.get("1095845193149862028") as TextChannel;
                    if (!onDutyChannel) {
