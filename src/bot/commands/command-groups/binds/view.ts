...
export default class BindViewSubcommand implements ICommand {
     name: Lowercase<string> = "view";
     description: string = "View existing role binds for the guild.";
     guardsman: Guardsman;
     ...
     async execute(interaction: ChatInputCommandInteraction<"cached">): Promise<void> {
          ...
          if (!guildRole) {
               ...
               for (const bind of allBinds) {
                    const roleData: RoleData<any> = JSON.parse(bind.role_data);
