...
import {
    ...
    ActionRowBuilder, ButtonBuilder, ButtonStyle, ComponentType, SlashCommandAttachmentOption
} from "discord.js";
import { getServerConfigs } from '../../../../utils/prismaUtils.js';
import { permissionsCheck } from '../../../../utils/roleFunctions.js'

export default class brFixSubCommand implements ICommand {
    name: Lowercase<string> = "fix";
    description: string = "Incase the buttons fail, this is used to accept/deny any requests.";
    guardsman: Guardsman;
